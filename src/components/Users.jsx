  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
       <div className="flex flex-col items-center">
            ...
            <button className="text-base font-semibold bg-orange-500 hover:bg-orange-600 w-[216px] h-[48px] rounded-[6px] shadow-[0_4px_4px_0_rgba(0,0,0,0.3)] mb-4" onClick={() => handleClick(true)}>Create New User</button>
                    ...
                    {users.map(user =>
                        <tr key={user.id} className="border-t bg-gray-800 border-gray-700">
                            ...
                            <td className="px-6 py-3 text-center">
                                <span className="material-symbols-outlined cursor-pointer select-none">delete</span>
                            </td>
                        </tr>
                    )}
                </tbody>
       ...
       {open && <CreateUsersDialog open={open} handleClick={handleClick} />}
    </div>
  );
};
