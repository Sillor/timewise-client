    ...
    <div className="flex flex-col items-center md:w-3/4 md:flex-none md:items-start">
      ...
      <div className="md:w-full">
        <table className="table-auto md:w-full md:text-[20px] mx-3 mb-5 text-light rounded-[4px]  bg-[#454545] overflow-hidden">
          <thead className=" ">
            <tr className="">
              <th className="text-center border-t border-[#5B5B5B]  px-5 py-1 md:py-2 font-semibold md:w-1/3">
                Name
              </th>
              <th className="text-center border-t border-[#5B5B5B]  px-5 py-1 md:py-2 font-semibold ">
                Total Hours Tracked
              </th>
            </tr>
          </thead>
          <tbody className="text-center">
            { (projectlist) && projectlist.map((item) => (
              <tr
                key={item.id}
                className="border-t border-[#5B5B5B] bg-[#303036]"
              >
